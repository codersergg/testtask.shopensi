...
Мониторинг событий (действий по добавлению/уменьшению золота) сохраняются в Kafka. В случае недоступности Kafka, данные мониторинга событий сохраняются в резервной системе хранения. Для демонстрации идеи в качестве резервной системы хранения реализовано сохранение в ConcurrentLinkedQueue<>. В случае восстановления Kafka, ранее направленные и новые события мониторинга записываются в Kafka.<br>
